...
def apply(connection, logger) -> None:
    ...
    logger.info("Migration 019: ensured platform service restart request table exists.")

    for statement in INDEX_STATEMENTS:
        connection.execute(text(statement))
    logger.info("Migration 019: ensured platform service restart request indexes exist.")
