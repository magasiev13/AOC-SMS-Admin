...
class TestSaasSchemaMigrations(unittest.TestCase):
    ...
    def test_saas_migrations_upgrade_from_prior_version(self) -> None:
        ...
        all_versions = ["001", "002", "003", "004", "005", "006", "007", "008", "009", "010"]
        ...
        self.assertEqual(partial_report["pending"], all_versions[1:])
        ...
        self.assertEqual(final_report["applied"], all_versions)
